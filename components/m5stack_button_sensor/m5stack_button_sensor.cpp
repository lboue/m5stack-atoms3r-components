...
#include "m5stack_button_sensor.h"
#include <M5GFX.h>

namespace esphome {
namespace m5stack_button_sensor {

static const char *TAG = "m5stack_button_sensor.sensor";

void M5StackButtonSensor::setup() {
  M5.begin();
}

void M5StackButtonSensor::loop() {
  M5.update();
...
void M5StackButtonSensor::dump_config(){
  ESP_LOGCONFIG(TAG, "Button Sensor");
}
