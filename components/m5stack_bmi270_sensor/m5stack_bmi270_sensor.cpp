...
#include "m5stack_bmi270_sensor.h"

namespace esphome {
namespace m5stack_bmi270_sensor {

static const char *const TAG = "m5stack_bmi270_sensor.sensor";
...
void M5StackBMI270Sensor::internal_setup_(int stage) {
  switch (stage) {
    case 0:
...
void M5StackBMI270Sensor::setup() { this->internal_setup_(0); }
void M5StackBMI270Sensor::dump_config() {
...
i2c::ErrorCode M5StackBMI270Sensor::read_le_int16_(uint8_t reg, int16_t *value, uint8_t len) {
...
void M5StackBMI270Sensor::update() {
...
float M5StackBMI270Sensor::get_setup_priority() const { return setup_priority::DATA; }
