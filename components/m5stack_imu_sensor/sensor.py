...
m5stack_imu_sensor_ns = cg.esphome_ns.namespace("m5stack_imu_sensor")
M5StackIMUSensor = m5stack_imu_sensor_ns.class_(
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(M5StackIMUSensor),
    ...
    .extend(i2c.i2c_device_schema(0x68)) # 0x68 is the default address of the BMI270
)
